        ...
        <div class="container card">
            ...
            <form action="edit.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_lengkap" placeholder="Masukkan Nama Lengkap" name="nama_lengkap" required value="<?php echo $d['nama_lengkap']; ?>">
                </div>
                <div class="form-group">
                    <label for="nama_lengkap">Tempat Lahir *</label>
                    <input type="text" class="form-control" id="tempat_lahir" placeholder="Masukkan Tempat Lahir" name="tempat_lahir" required value="<?php echo $d['tempat_lahir']; ?>">
                </div>
                <div class="form-group">
                    <label for="nama_lengkap">Tanggal Lahir *</label>
                    <input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir" required value="<?php echo $d['tgl_lahir']; ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control-sm" id="tinggi" placeholder="Masukkan Tinggi Badan" name="tinggi" required value="<?php echo $d['tinggi']; ?>"> cm
                </div>
                <div class="form-group">
                    <label for="nik">Berat Badan *</label>
                    <input type="number" class="form-control-sm" id="berat" placeholder="Masukkan Berat Badan" name="berat" required value="<?php echo $d['berat']; ?>"> kg
                </div>
                <div class="form-group">
                    <label for="provinsi">Provinsi *</label>
                    <select id="provinsi" name="provinsi" class="form-control" onclick="loadProvinsi()" required value="<?php echo $d['provinsi']; ?>">
                        <option value="">Pilih Provinsi</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="kota">Kabupaten/Kota *</label>
                    <select id="kota" name="kota" class="form-control" onclick="kabka()" required value="<?php echo $d['kota']; ?>">
                        <option value="">Pilih Kabupaten/Kota</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="kecamatan">Kecamatan *</label>
                    <select id="kecamatan" name="kecamatan" class="form-control" onclick="kec()" required value="<?php echo $d['kecamatan']; ?>">
                        <option value="">Pilih Kecamatan</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="kelurahan">Desa *</label>
                    <select id="kelurahan" name="desa" class="form-control" onclick="loadKelurahan()" required value="<?php echo $d['desa']; ?>">
                        <option value="">Pilih Desa</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="alamat_lengkap">Alamat Lengkap *</label>
                    <textarea class="form-control" id="alamat_lengkap" name="alamat_lengkap" rows="3" placeholder="Masukkan Alamat Lengkap Anda" required value="<?php echo $d['alamat_lengkap']; ?>"></textarea>
                </div>
                <div class="form-group">
